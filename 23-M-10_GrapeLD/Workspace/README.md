The scripts are located in the scripts folder. The first one is using PBS, which is now deprecated. The second one is using Slurm. I've attached a template file in there with comments

...
output_path = "C:/AgroBot/Dataset/Output/"

f = open(os.path.join(input_path, 'weedcoco.json'))
data = json.load(f)
f.close()
...
def load_images_from_folder(folder):
    ...
    for filename in os.listdir(folder):
        ...
        destination = os.path.join(images_dir, f"img{count}.jpg")
...
load_images_from_folder(os.path.join(input_path, 'images'))
...
for filename in file_names:
    ...
    if img_ann:
        ...
        file_object = open(os.path.join(output_path, 'labels', f"img{count}.txt"), "a")
